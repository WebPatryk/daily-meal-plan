...
export interface Message<T extends Role = Role> { role: T; content: string; }
...
export interface ModelParams { temperature?: number; top_p?: number; max_tokens?: number; stream?: boolean; [k: string]: unknown; }
export interface LLMResponse { raw: Response; usage: TokenUsage; message: Message<"assistant">; }
```
